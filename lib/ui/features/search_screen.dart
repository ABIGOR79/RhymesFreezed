...
//   Future<void> fetchRhymes(String word) async {
//     if (word.isEmpty) return;

//     final apiClient = RhymerApiClient.create(apiUrl: dotenv.env['API_URL']);

//     try {
//       final rhymesList = await apiClient.getRhymesList(word);
//       setState(() {
//         rhymes = rhymesList.map((r) => r.word).toList();
//         print(rhymes);
//       });
//     } catch (e) {
//       print("Ошибка: $e");
...
//               itemCount: 10,
//               itemBuilder: (context, index) {
//                 final listRyfm = List.generate(4, (_) => 'Ryfm');
//                 return RhymeHistoryCard(listRyfm: listRyfm);
//               },
//               separatorBuilder: (BuildContext context, int index) {
//                 return SizedBox(width: 4);
...
//             itemCount: 10,
//             itemBuilder: (context, index) {
//               return RhymeContainer(rhyme: 'Rhyme');
//             },
//             separatorBuilder: (BuildContext context, int index) {
//               return Divider(height: 2);
//             },
...
//             theme: widget.theme,
//             onTap: () {
//               fetchRhymes(textController.text);
